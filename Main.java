...
class TicTacToeGameinSwing implements ActionListener {
    ...
    TicTacToeGameinSwing() {
        ...
        frame.getContentPane().setBackground(new Color(225, 140, 28));
        frame.setTitle("Tic Tac Toe");
        frame.setLayout(new BorderLayout());
        frame.setVisible(true);

        textfield.setBackground(new Color(182, 172, 172));
        textfield.setForeground(new Color(112, 12, 12));
        ...
        bt_panel.setBackground(new Color(100, 84, 84));
    ...
    public void startGame() {
        try {
            textfield.setText("WEL-COME BACK!!!");
            Thread.sleep(4000);
    ...
    public void actionPerformed(ActionEvent e) {
        for (int i = 0; i < 9; i++) {
            if (e.getSource() == bton[i]) {
                if (pl1_chance) {
                    if (bton[i].getText() == "") {
                        bton[i].setForeground(new Color(61, 150, 185));
                        bton[i].setText("X");
                        pl1_chance = false;
                    ...
                    if (bton[i].getText() == "") {
                        bton[i].setForeground(new Color(81, 194, 84));
                        bton[i].setText("O");
                        pl1_chance = true;
